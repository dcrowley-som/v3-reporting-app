...
import {EpisodeCount, EpisodeCountCategory} from '../../models/episode-count';

@Component({
  selector: 'app-cases.count',
  imports: [Toolbar, Select, FormsModule, DatePicker, FloatLabel, Button, Card, DecimalPipe, Toast, UIChart,
  ConfirmDialog],
  templateUrl: './cases.count.component.html',
  standalone: true,
  styleUrl: './cases.count.component.scss',
  providers: [MessageService, ConfirmationService]
})
export class CasesCountComponent implements OnInit {
  ...
  public result = signal<EpisodeCount>({
    _id: 'all',
    anMinutes: 0,
    inRoomMinutes: 0,
    episodes: 0,
  ...
  public servicesResult = signal<EpisodeCount>({
    _id: 'all',
    anMinutes: 0,
    inRoomMinutes: 0,
    episodes: 0,
  ...
  public providersResult = signal<EpisodeCount>({
    _id: 'all',
    anMinutes: 0,
    inRoomMinutes: 0,
    episodes: 0,
  ...
  public proceduresResult = signal<EpisodeCount>({
    _id: 'all',
    anMinutes: 0,
    inRoomMinutes: 0,
    episodes: 0,
  ...
  // Categories
  public categories = linkedSignal<EpisodeCountCategory[]>(() => {
  ...
  public services = linkedSignal<EpisodeCountCategory[]>(() => {
  ...
  public providers = linkedSignal<EpisodeCountCategory[]>(() => {
  ...
  public procedures = linkedSignal<EpisodeCountCategory[]>(() => {
  ...
  refresh() {
    ...
    this.episodeService.count(this.selectedDateRange!.label as string, this.rangeDates, 'cat1')
      .subscribe((data: any) => {
  ...
  private refreshAll() {
    const sources = [
      this.episodeService.count(this.selectedDateRange!.label as string, this.rangeDates, 'service'),
      this.episodeService.count(this.selectedDateRange!.label as string, this.rangeDates, 'responsibleProvName'),
      this.episodeService.count(this.selectedDateRange!.label as string, this.rangeDates, 'procedure'),
    ];
